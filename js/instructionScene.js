...
class InstructionScene extends Phaser.Scene {
  ...
  create(data) {
    ...
    this.returnButton = this.add.sprite(600 / 4, 300 / 4 + 100, "returnButton")
    ...
    this.appleInstructionImage = this.add
      .sprite(0, 0, "appleInstruction")
      .setScale(0.8)
    this.appleInstructionImage.x = 800 / 2
    this.appleInstructionImage.y = 1800 / 2

    this.bananaInstructionImage = this.add
      .sprite(0, 0, "bananaInstruction")
      .setScale(0.5)
    this.bananaInstructionImage.x = 1350 / 2
    this.bananaInstructionImage.y = 1800 / 2

    this.pineappleInstructionImage = this.add
      .sprite(0, 0, "pineappleInstruction")
      .setScale(0.5)
    this.pineappleInstructionImage.x = 2450 / 2
    this.pineappleInstructionImage.y = 1800 / 2

    this.spikeInstructionImage = this.add
      .sprite(0, 0, "spikeInstruction")
      .setScale(0.5)
